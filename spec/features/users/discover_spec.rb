...
RSpec.describe 'Discover', type: :feature do
  it 'Displays Top Movies' do
    user_1 = User.create(name: 'John Doe', email: 'JohnDoe@gmail.com', password: '6789')
    user_2 = User.create(name: 'Homer Simpson', email: 'HomerSimpson@gmail.com', password: '6789')
