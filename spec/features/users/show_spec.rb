...
RSpec.describe 'Show', type: :feature do
  it "shows the user's information, 'Discover Movies button, and parties section" do
    user_1 = User.create(name: 'John Doe', email: 'John@gmail.com', password:'12345')
    user_2 = User.create(name: 'Homer Simpson', email: 'Homer@gmail.com', password: '6789')
  ...
  it 'shows the parties the user is hosting with details', :vcr do
    user_1 = User.create(name: 'John Doe', email: 'John@gmail.com', password: '6789')
    user_2 = User.create(name: 'Cory Doe', email: 'Cory@gmail.com', password: '6789')
