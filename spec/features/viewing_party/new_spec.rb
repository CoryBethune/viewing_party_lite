...
RSpec.describe 'viewing party new page' do
  before(:each) do
    @user1 = User.create!(name: 'Cory', email: 'cory@gmail.com', password: '6789')
    @user2 = User.create!(name: 'John', email: 'john@gmail.com', password: '6789')
    @user3 = User.create!(name: 'Kris', email: 'kris@gmail.com', password: '6789')
